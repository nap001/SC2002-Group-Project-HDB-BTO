...
public interface IEnquiryControl {
    ...
    void submitEnquiry(Applicant applicant, ProjectControl projectControl);
    ...
    void editEnquiry(Applicant applicant, ProjectControl projectControl);

    // Method to delete an enquiry created by the applicant
    void deleteEnquiry(Applicant applicant, ProjectControl projectControl);
